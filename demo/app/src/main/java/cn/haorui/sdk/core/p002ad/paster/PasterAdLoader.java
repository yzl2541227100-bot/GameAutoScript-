...
import cn.haorui.sdk.platform.p003hr.paster.HRPasterHRAdWrapper;

/* JADX INFO: loaded from: classes.dex */
public class PasterAdLoader extends AbstractC0497b<PasterAdListener> {
    ...
    public InterfaceC0508d createDelegate(SdkAdInfo sdkAdInfo, @NonNull HRAdInfo hRAdInfo) {
        return C0479a.m18a(sdkAdInfo.getSdk()).pasterLoader(this, sdkAdInfo, hRAdInfo);
    }
