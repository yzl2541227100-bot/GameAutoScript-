...
public class Scene {
    ...
    public static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0351R.id.transition_current_scene);
    }

    @NonNull
    public static Scene getSceneForLayout(@NonNull ViewGroup viewGroup, @LayoutRes int i, @NonNull Context context) {
        int i2 = C0351R.id.transition_scene_layoutid_cache;
    ...
    public static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0351R.id.transition_current_scene, scene);
    }
