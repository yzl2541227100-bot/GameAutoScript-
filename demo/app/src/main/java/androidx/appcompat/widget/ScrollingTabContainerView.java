...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class RunnableC00921 implements Runnable {
        ...
        public RunnableC00921(View view) {
            view = view;
        }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            int i = C0032R.attr.actionBarTabStyle;
    ...
    public void animateToTab(int i) {
        ...
        RunnableC00921 runnableC00921 = new Runnable() { // from class: androidx.appcompat.widget.ScrollingTabContainerView.1
            public final /* synthetic */ View val$tabView;

            public RunnableC00921(View childAt2) {
                view = childAt2;
            }
        ...
        this.mTabSelector = runnableC00921;
        post(runnableC00921);
    }
