...
public class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0032R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0032R.id.message);
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        if (rect.left < 0 && rect.top < 0) {
            ...
            int identifier = resources.getIdentifier("status_bar_height", "dimen", C3902g6.OooO0O0);
