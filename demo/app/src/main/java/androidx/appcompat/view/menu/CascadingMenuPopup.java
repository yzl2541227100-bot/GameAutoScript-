...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.1
        public ViewTreeObserverOnGlobalLayoutListenerC00621() {
        }
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.2
        public ViewOnAttachStateChangeListenerC00632() {
        }
    ...
    public class ViewTreeObserverOnGlobalLayoutListenerC00621 implements ViewTreeObserver.OnGlobalLayoutListener {
        public ViewTreeObserverOnGlobalLayoutListenerC00621() {
        }
    ...
    public class ViewOnAttachStateChangeListenerC00632 implements View.OnAttachStateChangeListener {
        public ViewOnAttachStateChangeListenerC00632() {
        }
    ...
    public class C00643 implements MenuItemHoverListener {
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(C0032R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
