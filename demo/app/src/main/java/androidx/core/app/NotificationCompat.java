...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m17058clone() {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0135R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0135R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            int iMin;
            boolean z3 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0135R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0135R.id.actions);
            if (!z || (arrayList = this.mBuilder.mActions) == null || (iMin = Math.min(arrayList.size(), 3)) <= 0) {
                z3 = false;
            } else {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0135R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z3 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0135R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0135R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0135R.layout.notification_action_tombstone : C0135R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0135R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0135R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0135R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0135R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0135R.id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0135R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0135R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0135R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0135R.id.title, 8);
            remoteViews.setViewVisibility(C0135R.id.text2, 8);
            remoteViews.setViewVisibility(C0135R.id.text, 8);
        }
        ...
        */
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i = C0135R.id.notification_main_column;
            remoteViews.removeAllViews(i);
            remoteViews.addView(i, remoteViews2.clone());
            remoteViews.setViewVisibility(i, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0135R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m17059clone() {
            WearableExtender wearableExtender = new WearableExtender();
