...
import androidx.recyclerview.C0269R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public class RunnableC03002 implements Runnable {
        public RunnableC03002() {
        }
    ...
    public static class InterpolatorC03013 implements Interpolator {
    ...
    public class C03024 implements ViewInfoStore.ProcessCallback {
        public C03024() {
        }
    ...
    public class C03035 implements ChildHelper.Callback {
        public C03035() {
        }
    ...
    public class C03046 implements AdapterHelper.Callback {
        public C03046() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public class C03051 implements ViewBoundsCheck.Callback {
            public C03051() {
            }
        ...
        public class C03062 implements ViewBoundsCheck.Callback {
            public C03062() {
            }
        ...
        public LayoutManager() {
            C03051 c03051 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.1
                public C03051() {
                }
            ...
            this.mHorizontalBoundCheckCallback = c03051;
            C03062 c03062 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.2
                public C03062() {
                }
            ...
            this.mVerticalBoundCheckCallback = c03062;
            this.mHorizontalBoundCheck = new ViewBoundsCheck(c03051);
            this.mVerticalBoundCheck = new ViewBoundsCheck(c03062);
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0269R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0269R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0269R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0269R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0269R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public final class Recycler {
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:187:0x0186 A[PHI: r1 r4
 ...
 binds: [B:142:0x005d, B:173:0x0102] A[DONT_GENERATE, DONT_INLINE]
  0x0186: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:142:0x005d, B:173:0x0102] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /* JADX WARN: Removed duplicated region for block: B:221:0x0226 A[ADDED_TO_REGION] */
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public static class C03071 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                Log.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started more than once. Each instance of" + getClass().getSimpleName() + C4196o4.OooO00o.OooO0Oo + "is intended to only be used once. You should create a new instance for each use.");
            }
            this.mRecyclerView = recyclerView;
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0269R.styleable.RecyclerView, i, 0);
            String string = typedArrayObtainStyledAttributes2.getString(C0269R.styleable.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(C0269R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z3 = typedArrayObtainStyledAttributes2.getBoolean(C0269R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z3;
            if (z3) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0269R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0269R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0269R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0269R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    */
    ...
    public String exceptionLabel() {
        return C4196o4.OooO00o.OooO0Oo + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    */
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable != null && drawable != null && stateListDrawable2 != null && drawable2 != null) {
            ...
            new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0269R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0269R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0269R.dimen.fastscroll_margin));
        } else {
