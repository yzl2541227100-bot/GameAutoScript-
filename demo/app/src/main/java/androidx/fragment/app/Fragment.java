...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public class C01822 extends FragmentContainer {
        public C01822() {
        }
    ...
    public class C01833 implements LifecycleOwner {
        public C01833() {
        }
    ...
    public static class SavedState implements Parcelable {
        ...
        public static class C01841 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }
