...
/* JADX INFO: renamed from: z2.zc */
/* JADX INFO: loaded from: classes2.dex */
public class C4611zc extends AbstractC3871fc {
    private static final String OooO0OO = "zc";
    private static final long OooO0Oo = 1;
    private static C4611zc OooO0o0;
    private OooO00o OooO0O0;

    /* JADX INFO: renamed from: z2.zc$OooO00o */
    ...
    public static C4611zc OooO0o() {
        if (OooO0o0 == null) {
            synchronized (C4611zc.class) {
                if (OooO0o0 == null) {
                    OooO0o0 = new C4611zc();
                }
            }
    ...
    public C4611zc OooO(OooO00o oooO00o) {
    ...
    public void OooOO0(Context context, String str, String str2, OooO00o oooO00o) {
        try {
            this.OooO0O0 = oooO00o;
            UploadDeviceScreenshotRequestInfo uploadDeviceScreenshotRequestInfo = new UploadDeviceScreenshotRequestInfo(C3834ec.OooO0OO().OooO00o(context));
            uploadDeviceScreenshotRequestInfo.ScriptId = str;
            uploadDeviceScreenshotRequestInfo.ImageOssPath = str2;
            String string = C4010j3.OooO(C4010j3.OooOOOo, InterfaceC4047k3.o00000oO, InterfaceC4047k3.o0000Oo0).build().toString();
            this.OooO00o.OooOO0(context, getClass().getCanonicalName(), string, C3834ec.OooO0OO().OooO(string, uploadDeviceScreenshotRequestInfo));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
