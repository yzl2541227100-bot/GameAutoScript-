...
/* JADX INFO: renamed from: z2.m4 */
/* JADX INFO: loaded from: classes.dex */
public class C4122m4 {

    /* JADX INFO: renamed from: z2.m4$OooO00o */
    public class OooO00o extends SimpleTarget<Bitmap> {
        public final /* synthetic */ InterfaceC4343s3 OoooOoO;

        public OooO00o(InterfaceC4343s3 interfaceC4343s3) {
            this.OoooOoO = interfaceC4343s3;
        }

        public void onResourceReady(@NonNull Bitmap bitmap, @Nullable InterfaceC4526x1<? super Bitmap> interfaceC4526x1) {
            InterfaceC4343s3 interfaceC4343s3 = this.OoooOoO;
            if (interfaceC4343s3 != null) {
                interfaceC4343s3.OooO00o(bitmap);
            }
        }
    ...
    /* JADX INFO: renamed from: z2.m4$OooO0O0 */
    ...
    public static void OooO00o(Context context, String str, ImageView imageView) {
        if (str.endsWith(".gif")) {
            C4230p1 c4230p1OooO0OO = OooO0OO();
            c4230p1OooO0OO.OooOOoo(o0oo0000.OooO0OO);
            OooOOO(context, str, imageView, c4230p1OooO0OO);
        } else {
            C4230p1 c4230p1OooO0OO2 = OooO0OO();
            c4230p1OooO0OO2.OooOOoo(o0oo0000.OooO0O0);
            OooOO0O(context, str, imageView, c4230p1OooO0OO2);
        }
    }

    public static void OooO0O0(Context context, String str, C4230p1 c4230p1, InterfaceC4343s3 interfaceC4343s3) {
        if (OooO0o0(context)) {
            o00Oo00.OooOooO(context).OooOOO0().OooO(str).OooOO0O(c4230p1).o0000o0o(new OooO00o(interfaceC4343s3));
        }
    }

    public static C4230p1 OooO0OO() {
        C4230p1 c4230p1 = new C4230p1();
        int i = C2604R.drawable.bg_normal_pic;
        return c4230p1.o0OOO0o(i).OooOoO0(i).o0OO00O(Priority.NORMAL);
    }

    public static C4230p1 OooO0Oo() {
        C4230p1 c4230p1OooOOO0 = new C4230p1().OooOOO0();
        int i = C2604R.drawable.bg_normal_pic;
        return c4230p1OooOOO0.o0OOO0o(i).OooOoO0(i).o0OO00O(Priority.NORMAL);
    }
    ...
    public static void OooO0oO(Context context, int i, ImageView imageView, C4230p1 c4230p1) {
        if (OooO0o0(context)) {
    ...
    public static void OooOO0(Context context, String str, ImageView imageView, o0O0o000 o0o0o000) {
        if (OooO0o0(context)) {
            C4230p1 c4230p1 = new C4230p1();
            int i = C2604R.drawable.bg_normal_pic;
            o00Oo00.OooOooO(context).OooO(str).OooOO0O(c4230p1.o0OOO0o(i).OooOoO0(i).o0OO00O(Priority.NORMAL).o00000Oo(o0o0o000)).o0000oOO(imageView);
        }
    }

    public static void OooOO0O(Context context, String str, ImageView imageView, C4230p1 c4230p1) {
        if (OooO0o0(context)) {
    ...
    public static void OooOO0o(Context context, byte[] bArr, ImageView imageView) {
        if (OooO0o0(context)) {
            C4230p1 c4230p1 = new C4230p1();
            int i = C2604R.drawable.bg_normal_pic;
            o00Oo00.OooOooO(context).OooO0OO(bArr).OooOO0O(c4230p1.o0OOO0o(i).OooOoO0(i).o0OO00O(Priority.HIGH).OooOOoo(o0oo0000.OooO00o)).o0000oOO(imageView);
        }
    }

    public static void OooOOO(Context context, String str, ImageView imageView, C4230p1 c4230p1) {
        if (OooO0o0(context)) {
    ...
    public static void OooOOOO(Context context, String str, InterfaceC4193o1<File> interfaceC4193o1) {
        if (OooO0o0(context)) {
