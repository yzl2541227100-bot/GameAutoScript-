...
public class C4422u8 {
    ...
    public class OooO00o implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            if (C4422u8.this.OooO0Oo != null) {
                C4422u8.this.OooO0Oo.OnLocationChange(location);
            }
        }
    ...
    /* JADX INFO: renamed from: z2.u8$OooO0O0 */
    ...
    private C4422u8(Context context) {
        this.OooO00o = context;
    }

    public static C4422u8 OooO0O0(Context context) {
        if (OooO0o0 == null) {
            OooO0o0 = new C4422u8(context);
        }
        return OooO0o0;
    }
