...
public class C1487a {
    ...
    public class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(C1814d.m9407b(EnumC1811a.ANYTHINK_OTHER), "mraid_js.txt");
                if (file.exists()) {
                    file.delete();
                }
                C1879m.m9736a(this.f7239a.getBytes(), file);
            } catch (Exception e) {
                e.getMessage();
            }
        }
    ...
    /* JADX INFO: renamed from: a */
    private void m6020a(Context context, final String str) {
        if (context == null) {
            return;
        }
        String strM8543a = C1772a.m8536a().m8543a(f7233a);
        if (TextUtils.isEmpty(strM8543a) || !strM8543a.equals(str)) {
            try {
                new C1484a(context).m9587a(str, (C1855b) null, new AbstractC1827b() { // from class: com.anythink.expressad.d.b.a.1
                    @Override // com.anythink.expressad.foundation.p120g.p126f.p128b.AbstractC1827b
                    /* JADX INFO: renamed from: a */
                    public final void mo6025a(String str2) {
                        if (TextUtils.isEmpty(str2)) {
                            return;
                        }
                        C1487a.this.f7236d = str2;
                        C1487a.m6023b(C1487a.this, str2);
                        C1772a.m8536a().m8544a(C1487a.f7233a, str);
                    }
    ...
    /* JADX INFO: renamed from: a */
    private void m6021a(String str) {
        C1335b.m3998a().m4005a(new AnonymousClass2(str));
    }
    ...
    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m6023b(C1487a c1487a, String str) {
        C1335b.m3998a().m4005a(c1487a.new AnonymousClass2(str));
    }

    /* JADX INFO: renamed from: c */
    private static String m6024c() {
        try {
            File file = new File(C1814d.m9407b(EnumC1811a.ANYTHINK_OTHER), "mraid_js.txt");
            return (file.exists() && file.canRead()) ? C1879m.m9729a(file) : "";
        } catch (Exception e) {
            e.getMessage();
            return "";
        }
