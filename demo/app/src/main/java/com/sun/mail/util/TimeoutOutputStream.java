...
public class TimeoutOutputStream extends OutputStream {
    ...
    private byte[] f18040b1;

    /* JADX INFO: renamed from: os */
    private final OutputStream f18041os;
    ...
    private final Callable<Object> timeoutTask = new Callable<Object>() { // from class: com.sun.mail.util.TimeoutOutputStream.1
        ...
        public Object call() throws Exception {
            TimeoutOutputStream.this.f18041os.close();
            return null;
        }
    };
    ...
    public synchronized void write(int i) throws IOException {
        if (this.f18040b1 == null) {
            this.f18040b1 = new byte[1];
        }
        byte[] bArr = this.f18040b1;
        bArr[0] = (byte) i;
        write(bArr);
    }
