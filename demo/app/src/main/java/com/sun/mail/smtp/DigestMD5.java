...
public class DigestMD5 {
    ...
    private Map<String, String> tokenize(String str) throws IOException {
        ...
        while (true) {
            ...
            if (this.logger.isLoggable(Level.FINE)) {
                this.logger.fine("Received => " + str3 + "='" + streamTokenizer.sval + "'");
            }
            if (map.containsKey(str3)) {
                str2 = ((String) map.get(str3)) + "," + streamTokenizer.sval;
            } else {
    ...
    public byte[] authClient(String str, String str2, String str3, String str4, String str5) throws IOException {
        ...
        try {
            ...
            this.uri = "smtp/".concat(String.valueOf(str));
            ...
            String str8 = map.get(HttpRequest.PARAM_CHARSET);
            ...
            sb.append(",qop=".concat("auth"));
            sb.append(",nc=".concat("00000001"));
    ...
    public boolean authServer(String str) throws IOException {
        ...
        this.logger.fine("Expected => rspauth=".concat(String.valueOf(hex)));
        return false;
    }
}
