...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static /* synthetic */ class C35291 {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> fromPublisher(vc0<? extends T> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new ObservableFromPublisher(vc0Var));
    }
    ...
    public final <R> R m16629as(@NonNull ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <R> R m16630to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C35291.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
