...
public abstract class ParallelFlowable<T> {
    @CheckReturnValue
    public static <T> ParallelFlowable<T> from(@NonNull vc0<? extends T> vc0Var) {
        return from(vc0Var, Runtime.getRuntime().availableProcessors(), Flowable.bufferSize());
    }

    @CheckReturnValue
    public static <T> ParallelFlowable<T> from(@NonNull vc0<? extends T> vc0Var, int i) {
        return from(vc0Var, i, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public static <T> ParallelFlowable<T> from(@NonNull vc0<? extends T> vc0Var, int i, int i2) {
        ObjectHelper.requireNonNull(vc0Var, "source");
        ObjectHelper.verifyPositive(i, "parallelism");
        ObjectHelper.verifyPositive(i2, "prefetch");
        return RxJavaPlugins.onAssembly(new ParallelFromPublisher(vc0Var, i, i2));
    }

    @CheckReturnValue
    @NonNull
    public static <T> ParallelFlowable<T> fromArray(@NonNull vc0<T>... vc0VarArr) {
        if (vc0VarArr.length != 0) {
            return RxJavaPlugins.onAssembly(new ParallelFromArray(vc0VarArr));
        }
    ...
    public final <R> R m16633as(@NonNull ParallelFlowableConverter<T, R> parallelFlowableConverter) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function) {
        return concatMap(function, 2);
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function, int i) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends vc0<? extends R>> function, int i, boolean z) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i, "prefetch");
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends vc0<? extends R>> function, boolean z) {
    ...
    @CheckReturnValue
    @NonNull
    public final ParallelFlowable<T> doOnSubscribe(@NonNull Consumer<? super xc0> consumer) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function) {
        return flatMap(function, false, Integer.MAX_VALUE, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function, boolean z) {
        return flatMap(function, z, Integer.MAX_VALUE, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function, boolean z, int i) {
        return flatMap(function, z, i, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends vc0<? extends R>> function, boolean z, int i, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    public abstract void subscribe(@NonNull wc0<? super T>[] wc0VarArr);

    @CheckReturnValue
    @NonNull
    /* JADX INFO: renamed from: to */
    public final <U> U m16634to(@NonNull Function<? super ParallelFlowable<T>, U> function) {
        try {
    ...
    public final boolean validate(@NonNull wc0<?>[] wc0VarArr) {
        int iParallelism = parallelism();
        if (wc0VarArr.length == iParallelism) {
            return true;
        }
        IllegalArgumentException illegalArgumentException = new IllegalArgumentException("parallelism = " + iParallelism + ", subscribers = " + wc0VarArr.length);
        for (wc0<?> wc0Var : wc0VarArr) {
            EmptySubscription.error(illegalArgumentException, wc0Var);
        }
        return false;
    }
}
