...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(vc0<? extends SingleSource<? extends T>> vc0Var) {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(vc0<? extends SingleSource<? extends T>> vc0Var, int i) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(vc0Var, SingleInternalHelper.toFlowable(), i, ErrorMode.IMMEDIATE));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concatEager(vc0<? extends SingleSource<? extends T>> vc0Var) {
        return Flowable.fromPublisher(vc0Var).concatMapEager(SingleInternalHelper.toFlowable());
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Single<T> fromPublisher(vc0<? extends T> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new SingleFromPublisher(vc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> merge(vc0<? extends SingleSource<? extends T>> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(vc0Var, SingleInternalHelper.toFlowable(), false, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> mergeDelayError(vc0<? extends SingleSource<? extends T>> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(vc0Var, SingleInternalHelper.toFlowable(), true, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    public final <R> R m16631as(@NonNull SingleConverter<T, ? extends R> singleConverter) {
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Single<T> delaySubscription(vc0<U> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleDelayWithPublisher(this, vc0Var));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Single<T> retryWhen(Function<? super Flowable<Throwable>, ? extends vc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <E> Single<T> takeUntil(vc0<E> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleTakeUntil(this, vc0Var));
    }
    ...
    public final <R> R m16632to(Function<? super Single<T>, R> function) {
        try {
