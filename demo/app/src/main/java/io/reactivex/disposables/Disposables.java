...
public final class Disposables {
    ...
    @NonNull
    public static Disposable fromSubscription(@NonNull xc0 xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "subscription is null");
        return new SubscriptionDisposable(xc0Var);
    }
}
