...
public class StatTracer implements InterfaceC3515b {
    ...
    /* JADX INFO: renamed from: com.umeng.commonsdk.statistics.internal.StatTracer$a */
    public static class C3513a {

        /* JADX INFO: renamed from: a */
        public static final StatTracer f19273a = new StatTracer();
    ...
    public static StatTracer getInstance(Context context) {
        if (mContext == null) {
            if (context != null) {
                ...
                MLog.m16269e("inside StatTracer. please check context. context must not be null!");
            }
        }
        return C3513a.f19273a;
    }
    ...
    @Override // com.umeng.commonsdk.statistics.internal.InterfaceC3515b
