...
public class IMAPProtocol extends Protocol {
    ...
    private static final byte[] DONE = {68, 79, 78, 69, C3442bg.f18781k, 10};
    ...
    public ByteArray getResponseBuffer() {
        ByteArray byteArray = this.f18029ba;
        this.f18029ba = null;
        return byteArray;
    }
    ...
    public Map<String, String> m15123id(Map<String, String> map) throws ProtocolException {
        C3316ID c3316id;
        if (!hasCapability("ID")) {
            throw new BadCommandException("ID not supported");
        }
        Response[] responseArrCommand = command("ID", C3316ID.getArgumentList(map));
        Response response = responseArrCommand[responseArrCommand.length - 1];
        if (response.isOK()) {
            int length = responseArrCommand.length;
            c3316id = null;
            for (int i = 0; i < length; i++) {
                if (responseArrCommand[i] instanceof IMAPResponse) {
                    ...
                    if (iMAPResponse.keyEquals("ID")) {
                        if (c3316id == null) {
                            c3316id = new C3316ID(iMAPResponse);
                        }
                        responseArrCommand[i] = null;
                    }
                }
        ...
        return c3316id.getServerParams();
    }

    @Deprecated
    /* JADX INFO: renamed from: id */
    public void m15124id(String str) throws ProtocolException {
        HashMap map = new HashMap();
        map.put("GUID", str);
        m15123id(map);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:63:0x0028 -> B:64:0x0029). Please report as a decompilation issue!!! */
    /*
    ...
    */
    public synchronized void idleStart() throws com.sun.mail.iap.ProtocolException {
        /*
            ...
            r4 = 0
            java.lang.String r3 = r5.writeCommand(r3, r4)     // Catch: java.lang.Exception -> L1a com.sun.mail.iap.LiteralException -> L20 java.lang.Throwable -> L6d
            r5.idleTag = r3     // Catch: java.lang.Exception -> L1a com.sun.mail.iap.LiteralException -> L20 java.lang.Throwable -> L6d
            goto L29
        L1a:
            r1 = move-exception
            com.sun.mail.iap.Response r1 = com.sun.mail.iap.Response.byeResponse(r1)     // Catch: java.lang.Throwable -> L6d
            goto L25
        L20:
            r1 = move-exception
            com.sun.mail.iap.Response r1 = r1.getResponse()     // Catch: java.lang.Throwable -> L6d
        L25:
        ...
        L29:
            if (r1 != 0) goto L47
            com.sun.mail.iap.Response r3 = r5.readResponse()     // Catch: com.sun.mail.iap.ProtocolException -> L30 java.io.IOException -> L32 java.lang.Throwable -> L6d
            goto L37
        L30:
            goto L29
        L32:
            r3 = move-exception
            com.sun.mail.iap.Response r3 = com.sun.mail.iap.Response.byeResponse(r3)     // Catch: java.lang.Throwable -> L6d
        L37:
        ...
        L47:
            ...
            com.sun.mail.iap.Response[] r1 = new com.sun.mail.iap.Response[r1]     // Catch: java.lang.Throwable -> L6d
            java.lang.Object[] r0 = r0.toArray(r1)     // Catch: java.lang.Throwable -> L6d
            com.sun.mail.iap.Response[] r0 = (com.sun.mail.iap.Response[]) r0     // Catch: java.lang.Throwable -> L6d
            int r1 = r0.length     // Catch: java.lang.Throwable -> L6d
            int r1 = r1 - r2
            r1 = r0[r1]     // Catch: java.lang.Throwable -> L6d
        ...
        L63:
            ...
            return
        L65:
            com.sun.mail.iap.BadCommandException r0 = new com.sun.mail.iap.BadCommandException     // Catch: java.lang.Throwable -> L6d
