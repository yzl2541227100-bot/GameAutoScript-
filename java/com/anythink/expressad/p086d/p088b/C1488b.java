package com.anythink.expressad.p086d.p088b;
...
import com.anythink.expressad.foundation.p120g.p126f.p128b.AbstractC1827b;
...
public class C1488b {
    ...
    public class AnonymousClass1 extends AbstractC1827b {
        ...
        @Override // com.anythink.expressad.foundation.p120g.p126f.p128b.AbstractC1827b
        /* JADX INFO: renamed from: a */
        public final void mo6025a(String str) {
            if (TextUtils.isEmpty(str)) {
                return;
            }
            C1488b.this.f7246f = str;
            C1488b.m6031b(C1488b.this, str);
            C1772a.m8536a().m8544a(C1488b.f7242b, this.f7247a);
        }

        @Override // com.anythink.expressad.foundation.p120g.p126f.p128b.AbstractC1827b
        /* JADX INFO: renamed from: f */
        public final void mo6026f() {
        }
    }
    ...
    public class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(C1814d.m9407b(EnumC1811a.ANYTHINK_OTHER), C1488b.f7243c);
                if (file.exists()) {
                    file.delete();
                }
                C1879m.m9736a(this.f7249a.getBytes(), file);
            } catch (Exception e) {
                String unused = C1488b.f7241a;
                e.getMessage();
            }
        }
    }
    ...
    /* JADX INFO: renamed from: a */
    public static C1488b m6027a() {
        if (f7245e == null) {
            synchronized (C1488b.class) {
                if (f7245e == null) {
                    f7245e = new C1488b();
                }
            }
    ...
    /* JADX INFO: renamed from: a */
    private void m6029a(Context context, String str) {
        if (context == null) {
            return;
        }
        String strM8543a = C1772a.m8536a().m8543a(f7242b);
        if (TextUtils.isEmpty(strM8543a) || !strM8543a.equals(str)) {
            try {
                new C1484a(context).m9587a(str, (C1855b) null, new AnonymousClass1(str));
            } catch (Exception e) {
                e.getMessage();
            }
        }
    ...
    /* JADX INFO: renamed from: a */
    private void m6030a(String str) {
        new Thread(new AnonymousClass2(str)).start();
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m6031b(C1488b c1488b, String str) {
        new Thread(c1488b.new AnonymousClass2(str)).start();
    }

    /* JADX INFO: renamed from: e */
    private static String m6034e() {
        try {
            File file = new File(C1814d.m9407b(EnumC1811a.ANYTHINK_OTHER), f7243c);
            return (file.length() <= 0 || !file.canRead()) ? "" : C1879m.m9729a(file);
        } catch (Exception e) {
            e.getMessage();
            return "";
        }
    ...
    public final String m6035b() {
        try {
            ...
            if (c1483aM6007b != null && !TextUtils.isEmpty(c1483aM6007b.m5939M())) {
                Context contextM8557e = C1773a.m8548c().m8557e();
                String strM5939M = c1483aM6007b.m5939M();
                if (contextM8557e != null) {
                    String strM8543a = C1772a.m8536a().m8543a(f7242b);
                    if (TextUtils.isEmpty(strM8543a) || !strM8543a.equals(strM5939M)) {
                        try {
                            new C1484a(contextM8557e).m9587a(strM5939M, (C1855b) null, new AnonymousClass1(strM5939M));
                        } catch (Exception e) {
                            e.getMessage();
                        }
                    }
