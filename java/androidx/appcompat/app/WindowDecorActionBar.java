...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class C00561 extends ViewPropertyAnimatorListenerAdapter {
        public C00561() {
        }
    ...
    public class C00572 extends ViewPropertyAnimatorListenerAdapter {
        public C00572() {
        }
    ...
    public class C00583 implements ViewPropertyAnimatorUpdateListener {
        public C00583() {
        }
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0032R.id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0032R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0032R.id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0032R.id.action_bar_container);
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0032R.styleable.ActionBar, C0032R.attr.actionBarStyle, 0);
        if (typedArrayObtainStyledAttributes.getBoolean(C0032R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0032R.styleable.ActionBar_elevation, 0);
