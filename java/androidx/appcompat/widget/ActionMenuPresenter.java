...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public class C00741 extends ForwardingListener {
            public final /* synthetic */ ActionMenuPresenter val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C00741(View view, ActionMenuPresenter actionMenuPresenter) {
                super(view);
        ...
        public OverflowMenuButton(Context context) {
            ...
            setOnTouchListener(new ForwardingListener(this) { // from class: androidx.appcompat.widget.ActionMenuPresenter.OverflowMenuButton.1
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C00741(View this, ActionMenuPresenter actionMenuPresenter) {
                    super(this);
                    actionMenuPresenter = actionMenuPresenter;
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        public static class C00751 implements Parcelable.Creator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel);
            }
