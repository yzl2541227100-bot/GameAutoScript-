...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0032R.styleable.PopupWindow, i, i2);
        ...
        setBackgroundDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0032R.styleable.PopupWindow_android_popupBackground));
