...
public final class LocaleListHelper {
    ...
    private static final Locale LOCALE_EN_XA = new Locale(C2069a.f13146X, "XA");
    private static final Locale LOCALE_AR_XB = new Locale(C2069a.f13144V, "XB");
