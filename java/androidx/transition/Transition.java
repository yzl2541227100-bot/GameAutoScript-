...
public abstract class Transition implements Cloneable {
    ...
    public static class C03581 extends PathMotion {
        @Override // androidx.transition.PathMotion
        public Path getPath(float f, float f2, float f3, float f4) {
            Path path = new Path();
            path.moveTo(f, f2);
    ...
    public class C03592 extends AnimatorListenerAdapter {
        public final /* synthetic */ ArrayMap val$runningAnimators;

        public C03592(ArrayMap arrayMap) {
            arrayMap = arrayMap;
        }
    ...
    public class C03603 extends AnimatorListenerAdapter {
        public C03603() {
        }
    ...
    private void runAnimator(Animator animator, ArrayMap<Animator, AnimationInfo> arrayMap) {
        if (animator != null) {
            animator.addListener(new AnimatorListenerAdapter() { // from class: androidx.transition.Transition.2
                ...
                public C03592(ArrayMap arrayMap2) {
                    arrayMap = arrayMap2;
                }
