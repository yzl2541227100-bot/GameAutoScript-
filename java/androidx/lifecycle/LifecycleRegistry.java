...
public class LifecycleRegistry extends Lifecycle {
    ...
    /* JADX INFO: renamed from: androidx.lifecycle.LifecycleRegistry$1 */
    ...
    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i = C02151.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
    ...
    public static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C02151.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
