...
/* JADX INFO: renamed from: z2.zl */
/* JADX INFO: loaded from: classes2.dex */
public final class C4620zl extends AbstractC4509wl {
    ...
    public C4620zl(byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        super(i5, i6);
        if (i3 + i5 > i || i4 + i6 > i2) {
    ...
    public final AbstractC4509wl OooO00o(int i, int i2, int i3, int i4) {
        return new C4620zl(this.OooO0OO, this.OooO0Oo, this.OooO0o0, this.OooO0o + i, this.OooO0oO + i2, i3, i4, false);
    }
