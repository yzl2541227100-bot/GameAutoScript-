...
public abstract class BasicFuseableSubscriber<T, R> implements FlowableSubscriber<T>, QueueSubscription<R> {
    ...
    public QueueSubscription<T> f19497qs;
    public int sourceMode;
    public xc0 upstream;

    public BasicFuseableSubscriber(wc0<? super R> wc0Var) {
    ...
    public final void onSubscribe(xc0 xc0Var) {
        if (SubscriptionHelper.validate(this.upstream, xc0Var)) {
            ...
            if (xc0Var instanceof QueueSubscription) {
                this.f19497qs = (QueueSubscription) xc0Var;
            }
            if (beforeDownstream()) {
