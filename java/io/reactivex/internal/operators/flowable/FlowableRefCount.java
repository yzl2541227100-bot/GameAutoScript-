...
public final class FlowableRefCount<T> extends Flowable<T> {
    ...
    public static final class RefCountSubscriber<T> extends AtomicBoolean implements FlowableSubscriber<T>, xc0 {
        ...
        public RefCountSubscriber(wc0<? super T> wc0Var, FlowableRefCount<T> flowableRefCount, RefConnection refConnection) {
    ...
    public void subscribeActual(wc0<? super T> wc0Var) {
        ...
        synchronized (this) {
            ...
            z = true;
            if (refConnection.connected || j2 != this.f19443n) {
                z = false;
            } else {
                refConnection.connected = true;
            }
        }
        this.source.subscribe((FlowableSubscriber) new RefCountSubscriber(wc0Var, this, refConnection));
        if (z) {
