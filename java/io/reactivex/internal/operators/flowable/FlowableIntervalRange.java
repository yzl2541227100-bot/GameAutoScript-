...
public final class FlowableIntervalRange extends Flowable<Long> {
    ...
    public static final class IntervalRangeSubscriber extends AtomicLong implements xc0, Runnable {
        ...
        public IntervalRangeSubscriber(wc0<? super Long> wc0Var, long j, long j2) {
    ...
    public void subscribeActual(wc0<? super Long> wc0Var) {
        IntervalRangeSubscriber intervalRangeSubscriber = new IntervalRangeSubscriber(wc0Var, this.start, this.end);
        wc0Var.onSubscribe(intervalRangeSubscriber);
