...
public final class FlowableFlatMapCompletable<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class FlatMapCompletableMainSubscriber<T> extends BasicIntQueueSubscription<T> implements FlowableSubscriber<T> {
        ...
        public FlatMapCompletableMainSubscriber(wc0<? super T> wc0Var, Function<? super T, ? extends CompletableSource> function, boolean z, int i) {
    ...
    public void subscribeActual(wc0<? super T> wc0Var) {
        this.source.subscribe((FlowableSubscriber) new FlatMapCompletableMainSubscriber(wc0Var, this.mapper, this.delayErrors, this.maxConcurrency));
    }
}
