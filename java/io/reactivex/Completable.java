...
public abstract class Completable implements CompletableSource {
    ...
    @CheckReturnValue
    public static Completable concat(vc0<? extends CompletableSource> vc0Var) {
    ...
    @CheckReturnValue
    @NonNull
    public static Completable concat(vc0<? extends CompletableSource> vc0Var, int i) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new CompletableConcat(vc0Var, i));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Completable fromPublisher(vc0<T> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new CompletableFromPublisher(vc0Var));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable merge(vc0<? extends CompletableSource> vc0Var) {
        return merge0(vc0Var, Integer.MAX_VALUE, false);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable merge(vc0<? extends CompletableSource> vc0Var, int i) {
        return merge0(vc0Var, i, false);
    }
    ...
    @CheckReturnValue
    @NonNull
    private static Completable merge0(vc0<? extends CompletableSource> vc0Var, int i, boolean z) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new CompletableMerge(vc0Var, i, z));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable mergeDelayError(vc0<? extends CompletableSource> vc0Var) {
        return merge0(vc0Var, Integer.MAX_VALUE, true);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable mergeDelayError(vc0<? extends CompletableSource> vc0Var, int i) {
        return merge0(vc0Var, i, true);
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> andThen(vc0<T> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "next is null");
        return RxJavaPlugins.onAssembly(new CompletableAndThenPublisher(this, vc0Var));
    }
    ...
    public final <R> R m16623as(@NonNull CompletableConverter<? extends R> completableConverter) {
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable repeatWhen(Function<? super Flowable<Object>, ? extends vc0<?>> function) {
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable retryWhen(Function<? super Flowable<Throwable>, ? extends vc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> startWith(vc0<T> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "other is null");
        return toFlowable().startWith((vc0) vc0Var);
    }
    ...
    public final <U> U m16624to(Function<? super Completable, U> function) {
        try {
