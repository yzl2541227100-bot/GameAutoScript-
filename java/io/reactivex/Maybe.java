...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concat(vc0<? extends MaybeSource<? extends T>> vc0Var) {
        return concat(vc0Var, 2);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(vc0<? extends MaybeSource<? extends T>> vc0Var, int i) {
        ObjectHelper.requireNonNull(vc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(vc0Var, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(vc0<? extends MaybeSource<? extends T>> vc0Var) {
        return Flowable.fromPublisher(vc0Var).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(vc0<? extends MaybeSource<? extends T>> vc0Var) {
        return Flowable.fromPublisher(vc0Var).concatMapEager(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(vc0<? extends MaybeSource<? extends T>> vc0Var) {
        return merge(vc0Var, Integer.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> merge(vc0<? extends MaybeSource<? extends T>> vc0Var, int i) {
        ObjectHelper.requireNonNull(vc0Var, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(vc0Var, MaybeToPublisher.instance(), false, i, 1));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(vc0<? extends MaybeSource<? extends T>> vc0Var) {
        return mergeDelayError(vc0Var, Integer.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> mergeDelayError(vc0<? extends MaybeSource<? extends T>> vc0Var, int i) {
        ObjectHelper.requireNonNull(vc0Var, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(vc0Var, MaybeToPublisher.instance(), true, i, 1));
    }
    ...
    public final <R> R m16627as(@NonNull MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    @CheckReturnValue
    @NonNull
    public final <U, V> Maybe<T> delay(vc0<U> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "delayIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelayOtherPublisher(this, vc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> delaySubscription(vc0<U> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "subscriptionIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelaySubscriptionOtherPublisher(this, vc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> Flowable<R> flatMapPublisher(Function<? super T, ? extends vc0<? extends R>> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Maybe<T> retryWhen(Function<? super Flowable<Throwable>, ? extends vc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> takeUntil(vc0<U> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new MaybeTakeUntilPublisher(this, vc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(vc0<U> vc0Var) {
        ObjectHelper.requireNonNull(vc0Var, "timeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, vc0Var, null));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(vc0<U> vc0Var, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(vc0Var, "timeoutIndicator is null");
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, vc0Var, maybeSource));
    }
    ...
    public final <R> R m16628to(Function<? super Maybe<T>, R> function) {
        try {
